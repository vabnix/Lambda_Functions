...
IgnoreFileName = ["pre-eventstore-cloudformation.json", "pre-Jaspersoft.json"]
counter = 0

for filename in directories:
    if filename.endswith(".json") and filename.startswith("pre-"):
...
# import json
#
# path = "/Users/vaibhavsrivastava/Documents/LWOLF/CF_Configuration/vabnix-pre-cf-templates"
# directories = os.listdir(path)
#
#
# def get_keys(dl, keys_list):
