...
path = "/Users/vaibhavsrivastava/Documents/LWOLF/CF_Configuration/lwt-stg-cf-templates"
...
IgnoreFileName = ["stg-JasperSoft-cloudformation.json"]
counter = 0

for filename in directories:
    if filename.endswith(".json") and filename.startswith("stg-"):
